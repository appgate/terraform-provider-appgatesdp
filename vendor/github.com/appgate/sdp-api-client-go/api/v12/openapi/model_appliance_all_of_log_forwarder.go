...
func (o *ApplianceAllOfLogForwarder) GetElasticsearch() ApplianceAllOfLogForwarderElasticsearch {
	if o == nil || o.Elasticsearch == nil {
		var ret ApplianceAllOfLogForwarderElasticsearch
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ApplianceAllOfLogForwarder) GetElasticsearchOk() (*ApplianceAllOfLogForwarderElasticsearch, bool) {
	if o == nil || o.Elasticsearch == nil {
		return nil, false
	}
...
func (o *ApplianceAllOfLogForwarder) SetElasticsearch(v ApplianceAllOfLogForwarderElasticsearch) {
	o.Elasticsearch = &v
}
