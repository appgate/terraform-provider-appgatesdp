...
// NewGatewayApplianceRoleAllOf instantiates a new GatewayApplianceRoleAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGatewayApplianceRoleAllOf() *GatewayApplianceRoleAllOf {
	this := GatewayApplianceRoleAllOf{}
	return &this
}

// NewGatewayApplianceRoleAllOfWithDefaults instantiates a new GatewayApplianceRoleAllOf object
...
type NullableGatewayApplianceRoleAllOf struct {
	value *GatewayApplianceRoleAllOf
	isSet bool
}

func (v NullableGatewayApplianceRoleAllOf) Get() *GatewayApplianceRoleAllOf {
	return v.value
}

func (v *NullableGatewayApplianceRoleAllOf) Set(val *GatewayApplianceRoleAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableGatewayApplianceRoleAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableGatewayApplianceRoleAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGatewayApplianceRoleAllOf(val *GatewayApplianceRoleAllOf) *NullableGatewayApplianceRoleAllOf {
	return &NullableGatewayApplianceRoleAllOf{value: val, isSet: true}
}
