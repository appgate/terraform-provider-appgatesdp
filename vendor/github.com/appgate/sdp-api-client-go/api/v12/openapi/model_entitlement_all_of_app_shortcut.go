...
// NewEntitlementAllOfAppShortcut instantiates a new EntitlementAllOfAppShortcut object
...
// NewEntitlementAllOfAppShortcutWithDefaults instantiates a new EntitlementAllOfAppShortcut object
...
type NullableEntitlementAllOfAppShortcut struct {
	value *EntitlementAllOfAppShortcut
	isSet bool
}

func (v NullableEntitlementAllOfAppShortcut) Get() *EntitlementAllOfAppShortcut {
	return v.value
}

func (v *NullableEntitlementAllOfAppShortcut) Set(val *EntitlementAllOfAppShortcut) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitlementAllOfAppShortcut) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitlementAllOfAppShortcut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitlementAllOfAppShortcut(val *EntitlementAllOfAppShortcut) *NullableEntitlementAllOfAppShortcut {
	return &NullableEntitlementAllOfAppShortcut{value: val, isSet: true}
}
