...
func (o *IdentityProvider) GetUserScripts() []string {
...
// and a boolean to check if the value has been set.
func (o *IdentityProvider) GetUserScriptsOk() (*[]string, bool) {
	if o == nil || o.UserScripts == nil {
		return nil, false
	}
...
func (o *IdentityProvider) HasUserScripts() bool {
	if o != nil && o.UserScripts != nil {
		return true
	}
...
func (o *IdentityProvider) SetUserScripts(v []string) {
	o.UserScripts = &v
}
