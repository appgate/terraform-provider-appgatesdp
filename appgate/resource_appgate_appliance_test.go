...
var testFor63AndAbove = func(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "prometheus_exporter.0.labels_disabled.0", "label1"),
					resource.TestCheckResourceAttr(resourceName, "prometheus_exporter.0.labels_disabled.1", "label2"),
