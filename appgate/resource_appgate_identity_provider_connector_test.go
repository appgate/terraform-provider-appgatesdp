		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "claim_mappings.0.attribute_name", "id"),
					resource.TestCheckResourceAttr(resourceName, "claim_mappings.0.claim_name", "id"),
					...
					resource.TestCheckResourceAttr(resourceName, "claim_mappings.4.attribute_name", "peerHostname"),
					resource.TestCheckResourceAttr(resourceName, "claim_mappings.4.claim_name", "peerHostname"),
					...
					resource.TestCheckResourceAttr(resourceName, "claim_mappings.6.attribute_name", "applianceApiVersion"),
					resource.TestCheckResourceAttr(resourceName, "claim_mappings.6.claim_name", "applianceApiVersion"),
